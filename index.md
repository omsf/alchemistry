...
{:.intro-text}
<span class="intro-lead">Welcome to the website for the annual conference on free energy methods for drug design.</span>
<br>
...
{:.center-container}
### Important Dates
{:.section-title style="font-size: 1.5rem;"}
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around; gap: 20px; align-items: stretch;">
  ...
  {% include logo_card.html
     logo_src="archive/2026/logos/Achira.png"
     alt_text="Tandem AI"
     url="https://achira.ai"
     name="Achira" %}
